...
<button type="button" class="btn btn-primary btn-lg" v-on:click.prevent="editSucursal()" data-toggle="tooltip" title="Click Sucursales ">
  Editar
</button>
            ...
            <div class="row">
                ...
                <div id="modulo1" class="col-sm-4 portfolio-item" style="display:none;">
                    <a href="{{ url('administrador') }} " class="portfolio-link" data-toggle="modal">
                        <div class="caption">
                            <div class="caption-content">
                                <i class="fa fa-search-plus fa-3x" >administrador 1</i>
                            </div>
                        </div>
